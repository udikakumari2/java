...
public class schoolApp extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("R/Eheliyagoda central college");

        jLabel2.setText("Select sudent number");

        jLabel3.setText("Student Name");

        jLabel4.setText("Mrks(PHP)");

        jLabel5.setText("marks(android)");

        jLabel6.setText("Marks1(java)");

        jLabel7.setText("Result(pass/fail)");

        jButton1.setText("Click to get Details");

        jButton2.setText("Click here to get Result(pass or fail)");
