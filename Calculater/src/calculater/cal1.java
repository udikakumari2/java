...
public class cal1 extends javax.swing.JFrame {
    ...
    public cal1() {
        initComponents();
        jRadioButton1.setEnabled(false);//ON button desable
    }
    public void Arithmetic_operaator(){
        switch(calculator){
            case 1://Addition
    ...
    public void disable(){
        ...
        jRadioButton2.setEnabled(false);//OFF button desable
